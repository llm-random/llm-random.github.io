...
One of the key inspirations for our work was structured pruning, where neuron/filter magnitude is often chosen as the measure of significance<!--citation-->. We were interested in how this metric evolves during the training process. At first, we thought a histogram of neuron magnitudes would exhibit a normal distribution. However, our experiments showed something different. The following graph shows evolution of neuron magnitudes throughout the training process. <!-- dodać zdanie, że większość layerów wygląda jak layer 1 -->
